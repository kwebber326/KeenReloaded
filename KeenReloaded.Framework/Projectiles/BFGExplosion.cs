...
namespace KeenReloaded.Framework.Projectiles
{
    public class BFGExplosion : RPGExplosion
    {
        ...
        protected override CollisionObject GetTopMostLandingTile(List<CollisionObject> collisions)
        {
            ...
            var landingTiles = collisions.Where(h => (h is DebugTile)
        ...
        protected override void HandleCollision(CollisionObject obj)
        {
            ...
            if (destructoObject != null && !destructoObject.IsDead() && !(destructoObject is CommanderKeen))
            {
        ...
        public new event EventHandler<KeenEventArgs.ObjectEventArgs> Create;

        public new event EventHandler<KeenEventArgs.ObjectEventArgs> Remove;
