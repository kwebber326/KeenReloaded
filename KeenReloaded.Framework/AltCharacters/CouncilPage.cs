...
namespace KeenReloaded.Framework.AltCharacters
{
    ...
    {
        public CouncilPage(SpaceHashGrid grid, Rectangle hitbox, Direction direction) : base(grid, hitbox, direction)
        {
            Initialize();
        }

        public CouncilPage(SpaceHashGrid grid, Rectangle hitbox, Direction direction, int lives, long points) : base(grid, hitbox, direction, lives, points)
        {
            Initialize();
        }
