...
namespace KeenReloaded.Framework.AltCharacters
{
    ...
    {
        public MortimerMcMire(SpaceHashGrid grid, Rectangle hitbox, Direction direction) : base(grid, hitbox, direction)
        {
            Initialize();
        }

        public MortimerMcMire(SpaceHashGrid grid, Rectangle hitbox, Direction direction, int lives, long points) : base(grid, hitbox, direction, lives, points)
        {
            Initialize();
        }
