...
{
    public class HorizontalExtendedBiomeTile : DebugTile, IBiomeTile
    {
        ...
        public HorizontalExtendedBiomeTile(SpaceHashGrid grid, Rectangle hitbox, BiomeType biome, TileType type, int lengths = 1)
            : base(grid, hitbox)
        {
            if (lengths <= 0)
        ...
        public static int GetWidthByTileTile(TileType type)
        {
            switch (type)
            {
        ...
        private void Initialize()
        {
            ...
            {
                this.HitBox = new Rectangle(this.Sprite.Location.X + EDGE_HORIZONTAL_OFFSET_LEFT, this.Sprite.Location.Y + VERTICAL_OFFSET, (this.Sprite.Width * _lengths) - EDGE_HORIZONTAL_OFFSET_LEFT, this.Sprite.Height - VERTICAL_OFFSET);
            }
            else if (_type == TileType.FLOOR_MIDDLE)
            {
                this.HitBox = new Rectangle(this.Sprite.Location.X, this.Sprite.Location.Y + VERTICAL_OFFSET, (this.Sprite.Width * _lengths), this.Sprite.Height - VERTICAL_OFFSET);
            }
            else if (_type == TileType.FLOOR_RIGHT_EDGE)
            {
                this.HitBox = new Rectangle(this.Sprite.Location.X, this.Sprite.Location.Y + VERTICAL_OFFSET, (this.Sprite.Width * _lengths) - EDGE_HORIZONTAL_OFFSET_RIGHT, this.Sprite.Height - VERTICAL_OFFSET);
            }
            else if (_type == TileType.WALL_RIGHT_EDGE)
            {
                this.HitBox = new Rectangle(this.Sprite.Location.X, this.Sprite.Location.Y + VERTICAL_OFFSET, (this.Sprite.Width * _lengths) - EDGE_HORIZONTAL_OFFSET_RIGHT /*24 * _lengths*/, this.Sprite.Height - VERTICAL_OFFSET);
            }
            else if (_type == TileType.WALL_LEFT_EDGE)
            {
                this.HitBox = new Rectangle(this.Sprite.Location.X + (EDGE_HORIZONTAL_OFFSET_LEFT), this.Sprite.Location.Y, (this.Sprite.Width * _lengths) - (EDGE_HORIZONTAL_OFFSET_LEFT), this.Sprite.Height);
            }
            else if (_type == TileType.WALL_MIDDLE)
            {
                this.HitBox = new Rectangle(this.Sprite.Location, new Size(this.Sprite.Width * _lengths, this.Sprite.Height));
            }
            else if (_type == TileType.CEILING)
            {
                this.HitBox = new Rectangle(this.Sprite.Location.X, this.Sprite.Location.Y, (this.Sprite.Width * _lengths), this.Sprite.Height - CEILING_VERTICAL_OFFSET);
            }
        ...
        private Image GetImageFromFiles()
        {
            ...
            var image = BitMapTool.CombineBitmap(fileList, _lengths, Color.Transparent);
            return image;
        }
