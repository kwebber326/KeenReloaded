...
{
    public class Keen5LaserTurret : Hazard, IUpdatable, IFireable, ICreateRemove
    {
        ...
        public Keen5LaserTurret(SpaceHashGrid grid, Rectangle hitbox, Direction direction, bool IsActive) :
            base(grid, hitbox, HazardType.KEEN5_LASER_TURRET)
        {
            _direction = direction;
            _isActive = IsActive;
            SetSpriteFromType(HazardType.KEEN5_LASER_TURRET);
        }
        ...
        protected override void SetSpriteFromType(HazardType type)
        {
            ...
            switch (_direction)
            {
                case Direction.RIGHT:
                    _sprite.Image = Properties.Resources.keen5_laser_turret_right;
                    ...
                    break;
                case Direction.LEFT:
                    _sprite.Image = Properties.Resources.keen5_laser_turret_left;
                    ...
                    break;
                case Direction.UP:
                    _sprite.Image = Properties.Resources.keen5_laser_turret_up;
                    break;
                case Direction.DOWN:
                    _sprite.Image = Properties.Resources.keen5_laser_turret_down;
                    break;
            }
