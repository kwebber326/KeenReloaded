...
namespace KeenReloaded.Framework
{
    public abstract class CollisionObject
    {
            ...
            else
            {
                foreach (SpaceHashGridNode node in _collidingNodes)
                {
                    if (node != null)
                    {
                        ...
                        {
                            node.Objects.Remove(this);
                            SetDebugDisplayColorForSpaceHashNode(node, Color.Gray);
                        ...
                        else
                        {
                            ...
                            SetDebugDisplayColorForSpaceHashNode(node, Color.Green);
        ...
        private void SetDebugDisplayColorForSpaceHashNode(SpaceHashGridNode node, Color color)
        {
            if (node != null && debug)
                node.Display.BackColor = color;
        }
